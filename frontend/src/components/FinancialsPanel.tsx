          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="bg-[#F1F5F9] border border-transparent text-xs text-[#64748B] rounded-xl py-1.5 px-3 focus:outline-none focus:bg-white focus:border-[#2563EB]"
              >
              ...
              {(activeTab === 'investments' || activeTab === 'assets' || activeTab === 'liabilities') ? (
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#F5F7FB] border border-[#E2E8F0] rounded-xl px-3 py-2 text-white placeholder-gray-600 focus:outline-none focus:border-[#2563EB] text-[#0F172A]"
                  />
                </div>
              ) : null}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="0.00"
                    className="w-full pl-7 pr-3 bg-[#F5F7FB] border border-[#E2E8F0] rounded-xl py-2 focus:outline-none focus:border-[#2563EB] font-mono font-bold text-[#0F172A]"
                  />
                </div>
              </div>
                  ...
                  <div className="flex bg-[#F5F7FB] p-1 rounded-xl border border-[#E2E8F0]">
                    <button
                      ...
                      className={`flex-1 py-1.5 rounded-lg font-bold transition-all ${
                        type === 'expense' ? 'bg-[#EF4444]/15 text-[#EF4444]' : 'text-[#64748B]'
                      }`}
                    >
                      Expense
                    </button>
                    <button
                      ...
                      className={`flex-1 py-1.5 rounded-lg font-bold transition-all ${
                        type === 'income' ? 'bg-[#22C55E]/15 text-[#22C55E]' : 'text-[#64748B]'
                      }`}
                    >
                      Income
                    </button>
