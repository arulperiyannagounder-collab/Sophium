        ...
        <div className="fixed inset-0 z-55 flex items-center justify-center p-4 bg-[#0F172A]/30 backdrop-blur-md">
          <div className="bg-white border border-[#E2E8F0] rounded-[24px] w-full max-w-md p-6 relative shadow-2xl animate-scale-up text-[#0F172A]">
            ...
            <form onSubmit={handleAddGoal} className="space-y-4 text-xs">
              ...
              <div>
                <label className="text-[#64748B] dark:text-slate-400 block mb-1 font-semibold">Goal Name</label>
                <input
                  type="text"
                  required
                  value={name}
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-3 py-2 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 text-slate-800 dark:text-slate-100 transition-all"
                />
              </div>
              
              <div>
                <label className="text-[#64748B] dark:text-slate-400 block mb-1 font-semibold">Category</label>
                <CustomSelect
                  value={category}
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div>
                <label className="text-[#64748B] dark:text-slate-400 block mb-1 font-semibold">Target Corpus (INR)</label>
                <input
                  type="number"
                  required
                  value={targetAmount}
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-3 py-2 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20 text-slate-800 dark:text-slate-100 transition-all font-mono"
                />
              </div>

              <div>
                <label className="text-[#64748B] dark:text-slate-400 block mb-1 font-semibold">Initial Balance (INR)</label>
                <input
                  type="number"
                  value={currentAmount}
              ...
              <div>
                <label className="text-[#64748B] dark:text-slate-400 block mb-1 font-semibold">Target (YYYY-MM)</label>
                <input
                  type="text"
                  required
                  value={targetDate}
            ...
            <div>
              <label className="text-[#64748B] dark:text-slate-400 block mb-1 font-semibold">Priority Level</label>
              <div className="flex bg-slate-50 dark:bg-slate-900 p-1 rounded-xl border border-slate-200 dark:border-slate-800 transition-all">
                {['Low', 'Medium', 'High'].map(p => (
                  <button
                    ...
                    className={`flex-1 py-1.5 rounded-lg font-bold transition-all cursor-pointer ${
                      priority === p 
                        ? 'bg-blue-650/15 dark:bg-blue-500/20 text-blue-600 dark:text-blue-400 shadow-sm' 
            ...
            <div className="pt-4 flex items-center justify-end gap-2 border-t border-slate-100 dark:border-slate-800/80">
              ...
              <button
                type="submit"
                disabled={loading}
                className="px-5 py-2 bg-[#2563EB] hover:bg-[#2563EB]/90 text-white rounded-xl font-bold transition-all disabled:opacity-50 cursor-pointer shadow-md shadow-blue-500/10"
              >
                {loading ? <Loader className="h-3.5 w-3.5 animate-spin" /> : 'Create Target'}
              </button>
            </div>
