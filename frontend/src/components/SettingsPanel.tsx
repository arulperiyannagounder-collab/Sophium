        ...
        <div className="bg-white border border-[#E2E8F0] rounded-[24px] p-6 lg:col-span-2 space-y-6 shadow-sm">
          ...
          <form onSubmit={handleUpdateProfile} className="space-y-4 text-xs text-[#0F172A]">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="text-[#64748B] block mb-1 font-semibold">Full Name</label>
                <input
                  type="text"
                  required
                  value={fullName}
              ...
              <div>
                <label className="text-[#64748B] block mb-1 font-semibold">Monthly Income (INR)</label>
                <input
                  type="number"
                  required
                  value={monthlyIncome}
              ...
              <div>
                <label className="text-[#64748B] block mb-1 font-semibold">Primary Currency</label>
                <select
                  value={currency}
              ...
              <div>
                <label className="text-[#64748B] block mb-1 font-semibold">Investment Risk Tolerances</label>
                <select
                  value={riskProfile}
              ...
              <div>
                <label className="text-[#64748B] block mb-1 font-semibold">Location / Country</label>
                <input
                  type="text"
                  value={country}
              ...
              <div>
                <label className="text-[#64748B] block mb-1 font-semibold">Timezone</label>
                <input
                  type="text"
                  value={timezone}
